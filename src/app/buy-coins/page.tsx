...
const coinPackages = [
  ...
  { coins: 1000, priceINR: 90, popular: true, dataAiHint: "treasure chest" }, // 10% discount
  { coins: 2500, priceINR: 220, popular: false, dataAiHint: "gold bars" }, // ~12% discount
  { coins: 5000, priceINR: 425, popular: false, dataAiHint: "vault door"}, // ~15% discount
  { coins: 10000, priceINR: 800, popular: false, dataAiHint: "money bag"}, // 20% discount
];
